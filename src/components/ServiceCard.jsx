...
export default function ServiceCard({ service, index, inView }) {
  ...
  return (
    <motion.div
      ...
      className="group relative p-6 card-surface hover:border-accent/20 transition-all duration-400 hover:-translate-y-1 hover:shadow-card-hover overflow-hidden"
    >
      <div
      ...
      <h3 className="heading-card text-base mb-2 tracking-tight group-hover:text-accent transition-colors">
        {title}
      </h3>
